			...
			switch(data.type) {
				...
				case "dataLogs": {
					...
					const select = query
						...
						.select(["logId as id", "timestamp as label", "signatures", "isHeader", "wasSent", "wasConfirmed", "hasError", "BlockchainAccount.blockchainAccountId as blockchainAccountId", "blockchainType"])
						.orderBy("timestamp");
